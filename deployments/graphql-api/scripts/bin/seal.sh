...
kubeseal <".secrets/unifi-secrets.json" >"secrets/unifi-secrets.json"
...
kubeseal <".secrets/ha-secrets.json" >"secrets/ha-secrets.json"
...
kubeseal <".secrets/graphql-secrets.json" >"secrets/graphql-secrets.json"
