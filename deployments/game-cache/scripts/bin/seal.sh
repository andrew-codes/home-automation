...
kubeseal <".secrets/mongodb-secrets.json" >"secrets/mongodb-secrets.json"
...
kubeseal <".secrets/gaming-pc-secrets.json" >"secrets/gaming-pc-secrets.json"
...
kubeseal <".secrets/twitch-secrets.json" >"secrets/twitch-secrets.json"
