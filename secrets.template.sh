...
export ALEXA_SHOPPING_LIST_SKILL_IP=""
export ALEXA_SHOPPING_LIST_SKILL_DNS_USERNAME=""
export ALEXA_SHOPPING_LIST_SKILL_DNS_PASSWORD=""
export ALEXA_SHOPPING_LIST_SKILL_DOMAIN=""

# Google Calendar integration
export GOOGLE_CALENDAR_CLIENT_ID=""
export GOOGLE_CALENDAR_CLIENT_SECRET=""

# Guest PIN code calendar integration
export GUEST_LOCK_CODE_EXCLUSIONS=""
export GOOGLE_GUEST_CALENDAR_ID=""
export GOOGLE_GUEST_CALENDAR_PRIVATE_KEY=""
export GOOGLE_GUEST_CALENDAR_SERVICE_ACCOUNT=""
