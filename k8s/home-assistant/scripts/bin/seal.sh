...
stop_game_shell_command: curl 'http://graphql-api/graphql' -H 'Accept-Encoding: gzip, deflate, br' -H 'Content-Type: application/json' -H 'Accept: application/json' -H 'Connection: keep-alive' -H 'Origin: altair://-' -H 'Authorization: Bearer $GRAPHQL_API_TOKEN' --data-binary '{"query":"\n\nmutation{\n  stopGameInGameRoom{\n    id\n  }\n}","variables":{}}' --compressed
