...
router_ip: $ROUTER_IP
turn_off_gaming_room_gaming_pc_command: 'ssh -t -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -i /root/.ssh/id_rsa $GAMING_ROOM_GAMING_PC_USERNAME@$GAMING_ROOM_GAMING_PC_IP cmd.exe "%windir%\System32\rundll32.exe powrprof.dll,SetSuspendState Standby"'
EOL
