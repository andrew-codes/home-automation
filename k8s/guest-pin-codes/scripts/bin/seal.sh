...
kubectl create secret generic guest-lock-entity-secrets --dry-run=client --namespace="home-automation" --from-file=guest_lock_entity_prefixes=".secrets/guest_lock_entity_prefixes" -o json >".secrets/guest-lock-entity-prefixes.json"
