...
lib.deployment.new(std.extVar('name'), std.extVar('image'), std.extVar('secrets'), std.extVars('externalPort'), 8091)
...
+ lib.deployment.withPort(0, 'ws', 3000, std.extVar('wsPort'))
+ lib.deployment.withProbe(0, '/health')
+ lib.deployment.withPersistentVolume('zwave', '5Gi', '/mnt/data/zwave')
