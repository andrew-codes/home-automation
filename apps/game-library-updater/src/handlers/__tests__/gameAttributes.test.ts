...
describe("Given a valid topic and payload containing multiple references to single game with differing platforms", () => {
  test("When handling the message, then the multiple references are condensed down to a single game reference to be stored in the games table.", async () => {
    jest.mocked(v4).mockReturnValue("4d87f530-bee9-4f73-9d86-032819ff6ca8")
    ...
    expect(updateOneGame).toBeCalledWith(
      { _id: "4d87f530-bee9-4f73-9d86-032819ff6ca8" },
      expect.objectContaining({
        $set: expect.objectContaining({
          id: "4d87f530-bee9-4f73-9d86-032819ff6ca8",
          ...
          platformReleaseIds: [
            "a7aae1e8-8a12-4282-9d4f-5ad2f70f6a37_4d87f530-bee9-4f73-9d86-032819ff6ca8",
            "6ac977b9-f496-4c49-bb38-f9627a67affc_4d87f530-bee9-4f73-9d86-032819ff6ca8",
          ],
        }),
      }),
      { upsert: true },
  ...
  test("When handling the message, each game release reference is stored in the gamesReleases table.", async () => {
    ...
    expect(updateGameRelease).toBeCalledWith(
      {
        _id: "a7aae1e8-8a12-4282-9d4f-5ad2f70f6a37_4d87f530-bee9-4f73-9d86-032819ff6ca8",
      },
      expect.objectContaining({
        $set: expect.objectContaining({
          id: "a7aae1e8-8a12-4282-9d4f-5ad2f70f6a37_4d87f530-bee9-4f73-9d86-032819ff6ca8",
          playniteId: "3d87f530-bee9-4f73-9d86-032819ff6ca8",
          added: new Date(Date.parse("2021-12-23T09:20:32.303-05:00")),
          communityScore: 85,
          criticScore: 86,
          gameId: "4d87f530-bee9-4f73-9d86-032819ff6ca8",
          description:
    ...
    expect(updateGameRelease).nthCalledWith(
      2,
      {
        _id: "6ac977b9-f496-4c49-bb38-f9627a67affc_4d87f530-bee9-4f73-9d86-032819ff6ca8",
      },
      expect.objectContaining({
        $set: expect.objectContaining({
          id: "6ac977b9-f496-4c49-bb38-f9627a67affc_4d87f530-bee9-4f73-9d86-032819ff6ca8",
