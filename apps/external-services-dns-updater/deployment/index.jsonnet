...
+ lib.deployment.withInitContainer('mqtt-is-ready', 'docker-registry:5000/mqtt-client:latest', 'sh', ['-c', 'timeout 10 sub -h 192.168.1.18 -p 30519 -t "$SYS/#" -C 1 | grep -v Error || exit 1'],)
