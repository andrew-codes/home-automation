...
local pbsService = k.core.v1.service.new('pbs', {}, [
  { name: 'pbs', port: 8007, protocol: 'TCP', targetPort: 8007 },
])
;
local pbsEndpoint = k.core.v1.endpoints.new('pbs')
                    + k.core.v1.endpoints.withSubsets([
                      {
                        addresses: [
                          { ip: '10.3.95.93' },
                        ...
                        ports: [
                          { name: 'pbs', port: 8007, protocol: 'TCP' },
                        ],
                      },
                    ])
;
