...

{
  ...
  "backup/config": k.core.v1.envVar.fromSecretRef("BACKUP_CONFIG", "backup-config", 'secret-value'),
  "backup/nas/ssh-key/private": k.core.v1.envVar.fromSecretRef("BACKUP_NAS_SSH_KEY_PRIVATE", "backup-nas-ssh-key-private", 'secret-value'),
  "backup/ssh-key/private": k.core.v1.envVar.fromSecretRef("BACKUP_SSH_KEY_PRIVATE", "backup-ssh-key-private", 'secret-value'),
  "backup/ssh-key/public": k.core.v1.envVar.fromSecretRef("BACKUP_SSH_KEY_PUBLIC", "backup-ssh-key-public", 'secret-value'),
