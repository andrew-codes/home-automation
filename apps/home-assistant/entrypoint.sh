...
GAMING_ROOM_NINTENDO_SWITCH_IP: \"${HOME_ASSISTANT_GAME_ROOM_NINTENDO_SWITCH_IP}\"
...
HA_AUTHORIZATION_HEADER: \"Bearer ${HOME_ASSISTANT_TOKEN}\"
...
GITHUB_AUTHORIZATION_HEADER: \"${HOME_ASSISTANT_GITHUB_AUTHORIZATION_HEADER}\"
...
O365_CLIENT_ID: \"${HOME_ASSISTANT_O365_CLIENT_ID}\"
O365_CLIENT_SECRET: \"${HOME_ASSISTANT_O365_CLIENT_SECRET}\"
" >/config/secrets.yaml
